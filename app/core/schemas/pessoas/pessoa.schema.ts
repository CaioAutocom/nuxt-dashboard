...
import { transportadoraSchema } from './transportadora.schema'
import { fornecedorSchema } from './fornecedor.schema'
import { vendedorSchema } from './vendedor.schema'
import { EGenero } from '~/core/enums/EGenero'
import { contatoBaseZod } from './contato.schema'
...
export const pessoaSchema = z
  .object({
    ...
    contatos: z.array(contatoBaseZod).nullish().describe('Lista de contatos da pessoa.'),
